<x-app-layout>
    ...
    <div class="card shadow">
        ...
        <form action="{{route('section.class.subject.allocation.register',[$sectionClassSubjectTeacher->sectionClassSubject->sectionClass->id, $sectionClassSubjectTeacher->id])}}" method="post">
                @csrf
